...
const aboutImage = "/toma image2nd.png";
  ...
  return (
    <>
      ...
      <div className="flex justify-center ">
        <span className="p-3 text-xl bg-[#52b788] rounded-2xl font-bold text-white">
          About me
        </span>
      </div>
      ...
      <div className="mt-3  ">
        {/* Main Section */}
        <div className="flex justify-center mt-2 sm:mt-12 lg:mt-2">
          <div className="hero-content flex-col lg:flex-row max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 gap-16 lg:gap-28 bg-base-100 py-6 rounded-xl">
            ...
            <div className="mt-2 lg:mt-0">
              ...
              <p className="leading-relaxed text-base sm:text-lg mt-4">
                ...
                Tailwind CSS and DaisyUI. My focus is on creating clean,
                efficient, and user-friendly interfaces that provide excellent
                user experiences across all devices. you can follow me on{" "}
              ...
              <p className="mt-3">
                ...
                to reach out and say hello! Promise I don't bite{" "}
